...
export function conf(): RuntimeConfig {
  return {
    ...
    DISCORD_LINK,
    TELEGRAM_LINK: getKey("TELEGRAM_LINK", TELEGRAM_LINK),
    TWITTER_LINK: getKey("TWITTER_LINK", TWITTER_LINK),
    DMCA_EMAIL: getKey("DMCA_EMAIL"),
    ONBOARDING_CHROME_EXTENSION_INSTALL_LINK: getKey(
      "ONBOARDING_CHROME_EXTENSION_INSTALL_LINK",
      "https://chromewebstore.google.com/detail/nexus-enchanced/geimjiobahmbkmaigaafjnoanebpmlmj",
    ),
    ONBOARDING_FIREFOX_EXTENSION_INSTALL_LINK: getKey(
      "ONBOARDING_FIREFOX_EXTENSION_INSTALL_LINK",
      "https://addons.mozilla.org/en-US/firefox/addon/nexus-extension-v1/",
    ),
