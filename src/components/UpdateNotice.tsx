...
/**
 * Popup 2 of the shared top-center popup slot. Waits for the maintenance
 * popup to finish, then announces the new app version. Auto-closes after
 * 3.5s; only the manual X stores the dismissal for that version.
 */
export function UpdateNotice() {
  ...
  useEffect(() => {
    if (updateAvailable && phase === "waiting") setPhase("queued");
  }, [updateAvailable, phase]);
